                 ...
                 <form id="add_client">
                    <div class="row">
                        ...
                        <div class="col-4  p-3 pt-5">City:
                            <div id="loadCity">
                                <select name="" id="" class='form-select'><option value=""  >----Select City----</option></select>
                            </div>
                        </div>
                        <div class="col-4  p-3 pt-5">Pincode:<input type="Number" id="client_pincode" class="form-control mb-3"><div id="pincode_valid" class="text-danger mb-3 "></div></div>
...
<div class="modal " id="myModal" data-bs-backdrop="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="" class="update_client_form">
