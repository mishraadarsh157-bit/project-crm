<div id="left_sidebar" class="left_sidebar bg-white border-end border-dark  col-2 pt-5  " >
    ...
    <div class="masters d-flex align-items-start ms-5 text-muted" >
        ...
        <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical" align='left'>

            <a href="<?php echo "/project/usermaster/"; ?>" onclick='userData()' id="user_master">
                <button  class="nav-link fw-bold side1" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="bi bi-people me-3"></i> USER MASTER</button>
            </a>
<hr>
            <a href="<?php echo "/project/clientmaster/"; ?>" onclick='clientData()' id="client_master">
                <button class="nav-link fw-bold side2" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
