<div class="header  container-fluid m-0 row border-bottom border-dark w-100 p-0">
    ...
    <div class="col-10 naav p-2 d-flex justify-content-between  m-0 bg-white">
        <button id="hide_sidebar" class="btn btn-sm btn-outline-dark border border-0  ms-5"><i class="bi bi-chevron-double-left"></i></i></button>

        <button id="show_sidebar" class="btn btn-sm btn-outline-dark border border-0  ms-5"><i class="bi bi-chevron-double-right"></i></button>
    ...
    <div class="exit">
    <hr>   
            <button class="btn bg-danger  mx-auto btn-sm rounded  w-75 text-white logout" value="logout" ">
