...
function resetUserForm(){
  ...
  $('.updBtn').html('<input type="button" value="SAVE" id="save_user" class="save btn-outline-primary   btn my-3" onclick="insertUser()">\
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      data.data.forEach(function(value){
        ...
        $('.password').html(`Status<select id='user_status' class='form-select mb-5' value='${value['STATUS']}'>
      ...
      $('.updBtn').html("<input type='button' onclick='userData()' class='btn btn-outline-primary' id='edit' value='EDIT'>\
